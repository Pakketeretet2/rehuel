...
solver_coeffs get_coefficients( int method )
{
	...
	case LOBATTO_IIIC_43:
		...
		sc.A = { { 1.0/6.0, -1.0/3.0, 1.0/6.0 },
		         ...
		         { 1.0/6.0, 2.0/3.0, 1.0/6.0 } };
		sc.b  = { 1.0/6.0, 2.0/3.0, 1.0/6.0 };
		sc.b2 = { 1.0/6.0, 1.0/6.0, 2.0/3.0, }; // -1.0/6.0, 5.0/6.0, 0. };
		sc.c  = { 0.0, 0.5, 1.0 };
		sc.order = 4;
		sc.order2 = 2;
	...
	case LOBATTO_IIIC_64:

		sc.A = { { 1.0/12.0, -sqrt(5)/12., sqrt(5)/12., -1.0/12.0 },
		         { 1.0/12.0, 0.25, (10 - 7*sqrt(5))/60., sqrt(5)/60.},
		         { 1.0/12.0, (10 + 7*sqrt(5))/60., 0.25, -sqrt(5)/60.},
		         { 1.0/12.0, 5.0/12.0, 5.0/12.0, 1.0/12.0 } };
		sc.b  = { 1.0/12.0, 5.0/12.0, 5.0/12.0, 1.0/12.0 };
		sc.b2 = { 1.0/12.0, 1.0/12.0, 5.0/12.0, 5.0/12.0};
		sc.c  = { 0.0, 0.5 - sqrt(5)/10., 0.5 + sqrt(5)/10., 1.0 };
		sc.order = 6;
		sc.order2 = 4;
	...
	case LOBATTO_IIIC_85:
		...
		sc.b2 = {0.05, 0.05, 49/180.0, 16/45.0, 49/180.0};
		sc.gamma  = 0.1894964436645163;
		sc.order  = 8;
		sc.order2 = 5;
